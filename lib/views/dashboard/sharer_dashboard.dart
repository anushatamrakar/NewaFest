      ...
      child: GestureDetector(
        onTap: (){
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => ViewRecipe(id: recipeData['id'], route: '/chef_dash',),
            ),
          );
        },
        child: Card(
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ChefCustomerProfilePage( route: '/chef_dash', uid:  userData['id'],),
          ),
        );
      },
      child: Container(
            ...
            return GestureDetector(
              onTap:(){
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ViewRecipe(id: recipe['id'], route: '/chef_dash',),
                  ),
                );
              },
              child: Card(
